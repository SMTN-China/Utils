...
namespace LablePrint.BarCode
{
    ...
    public class DrawBarcodes : DrawItemBase
    {
        ...
        public DrawBarcodes(int x, int y)
        {
            ...
            startYscale = y;
            Ibarcodes = barcodefactory.CreateBarcode("LablePrint.BarCode.Code39,LablePrint");
            printItem.Add(new PrintItem() { ID = "Code39", Value = "Code39" });
        }
            ...
            set
            {
                ...
                switch (eBarcodeType)
                {
                    ...
                    case BarcodeType.Code93:
                        ...
                        nBarcodeHeight = 32;
                        printItem.Add(new PrintItem() { ID = "Code93", Value = "Code93" });
                        break;
                    case BarcodeType.QRcode:
                        CreateBarcodeInterFace(BarcodeType.QRcode);
                        nBarcodeHeight = 79;
                        ShowText = false;
                        printItem.Add(new PrintItem() { ID = "QRcode", Value = "QRcode" });
                        break;
                    case BarcodeType.DataMatrix:
                        CreateBarcodeInterFace(BarcodeType.DataMatrix);
                        nBarcodeHeight = 79;
                        ShowText = false;
                        printItem.Add(new PrintItem() { ID = "DataMatrix", Value = "DataMatrix" });
                        break;
                    case BarcodeType.Code128A:
                        CreateBarcodeInterFace(BarcodeType.Code128A);
                        nBarcodeHeight = 32;
                        printItem.Add(new PrintItem() { ID = "CODE128A", Value = "CODE128A" });
                        break;
                    case BarcodeType.Code128B:
                        ...
                        printItem.Add(new PrintItem() { ID = "Code128B", Value = "Code128B" });
                        break;
                    case BarcodeType.Code128C:
                    case BarcodeType.UCC_EAN128:
                        Ibarcodes = barcodefactory.CreateBarcode("CIT.BarCode.Code128Base,CIT.BarCode", eBarcodeType);
                        Ibarcodes.BarcodeRect = barcodeRectangle;
                        printItem.Add(new PrintItem() { ID = "01234567", Value = "01234567" });
                        break;
                    case BarcodeType.EAN13:
                        CreateBarcodeInterFace(BarcodeType.EAN13);
                        printItem.Add(new PrintItem() { ID = "690|8888|88878", Value = "690|8888|88878" });
                        break;
                    case BarcodeType.UPCA:
                        CreateBarcodeInterFace(BarcodeType.UPCA);
                        printItem.Add(new PrintItem() { ID = "9|88888|88888", Value = "9|88888|88888" });
                        break;
                    case BarcodeType.Interleaved2of5:
                        CreateBarcodeInterFace(BarcodeType.Interleaved2of5);
                        printItem.Add(new PrintItem() { ID = "123456", Value = "123456" });
                        break;
                    case BarcodeType.Standard2of5:
                        CreateBarcodeInterFace(BarcodeType.Standard2of5);
                        printItem.Add(new PrintItem() { ID = "0123456", Value = "0123456" });
                        break;
                    case BarcodeType.Code11:
                        CreateBarcodeInterFace(BarcodeType.Code11);
                        printItem.Add(new PrintItem() { ID = "1234-1234", Value = "1234-1234" });
                        break;
                    case BarcodeType.Codabar:
                        CreateBarcodeInterFace(BarcodeType.Codabar);
                        printItem.Add(new PrintItem() { ID = "A123456A", Value = "A123456A" });
                        break;
        ...
        internal void CreateBarcodeInterFace(BarcodeType be)
        {
            ...
            Ibarcodes = barcodefactory.CreateBarcode("LablePrint.BarCode." + Enum.GetName(typeof(BarcodeType), be) + ",LablePrint");
            Ibarcodes.BarcodeRect = barcodeRectangle;
        }
